                    ...
                    <Form horizontal form={this.props.form}>
                        {columns.map(column => {
                            if(column.dataIndex == 'id'){
                                return (
                                    <FormItem {...formItemLayout} label={column.title + "："} key={column.dataIndex} style={{'display': 'none'}}>
                                ...
                                if(column.dataIndex !=null)
                                    if (column.type === undefined || column.type == null || column.type == 'text') {
                                        ...
                                        return (
                                            <FormItem {...formItemLayout} label={column.title + "："} key={column.dataIndex}>
                                                <Cascader style={{ width: 200 }} allowClear={false} options={column.selectOptions} 
                                                expandTrigger="hover" value={option}   displayRender={this.displayRender} 
                                                onChange={this.onCascaderChange.bind(this, column.dataIndex)} />
